...
if ($display == 'complete') {
    header('Location: data.php?success=' . rand(0, 123) . '&#data');
}
?>
<h3>edit 1</h3>

<form method="post" class="form-vertical form-edit-profile" action="form.php" data-ajax-url="inc/form.php"
      data-ajax-update-element=".form-replace-container">
